...
BEGIN
    ...
    ALTER QUEUE server_a_service_queue
    ...
    IF @is_receive_enabled = 0
        ALTER QUEUE server_a_service_queue WITH STATUS = OFF;
    IF @is_activation_enabled = 1
        ALTER QUEUE server_a_service_queue WITH ACTIVATION (STATUS = ON);
